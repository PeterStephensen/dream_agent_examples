...
class Agent:
    ...
    def get_random_agents(self, not_this_agent=None, n=1):
        ...
        if (not_this_agent is not None) and (not isinstance(not_this_agent, Agent)):
            raise SystemExit('Error: Argument not_this_agent in get_random_agent should be None or Agent.')
